...
class UserChatPreference(db.Model):
    ...
    disappearing_days = db.Column(db.Integer, default=0) # 0 = Off, 1 = 1 day, 7 = 7 days, etc.
    ...
    def to_dict(self):
        return {
            ...
            'disappearing_days': self.disappearing_days or 0,
...
class UserReport(db.Model):
    ...
    message_id = db.Column(db.Integer, db.ForeignKey('messages.id'), nullable=True)
    reason = db.Column(db.String(100), nullable=False) # e.g. 'Harassment', 'Spam', 'Screenshot Abuse', 'Tampering'
    details = db.Column(db.Text, nullable=True)
    ...
    def to_dict(self):
        return {
            ...
            'reported_username': self.reported_user.username if self.reported_user else 'Unknown',
